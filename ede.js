...
(async function () {
  ...
  if (
      ...
      constructor() {
        ...
        if (window.localStorage.getItem('is_danmaku_show') == null) {
          ...
          this.is_danmaku_show =
            window.localStorage.getItem('is_danmaku_show') === 'true';
        }
        this.danmaku = null;
    ...
    var _$ = $.noConflict();
    /* jQuery plugin: wait  */
    _$.fn.wait = function (func, times, interval) {
      var _times = times || -1,
    ...
    !(function (t, i) {
      ...
      function e(e, n) {
        if ('function' == typeof e.render) {
          ...
          if (s instanceof HTMLCanvasElement)
            return (e.width = s.width), (e.height = s.height), s;
        }
        ...
        var o = 1 * a.lineWidth;
        for (var d in ((o =
          o > 0 && o !== 1 / 0 ? Math.ceil(o) : 1 * !!a.strokeStyle),
        (r.font = a.font),
        (e.width =
          e.width ||
          Math.max(1, Math.ceil(r.measureText(e.text).width) + 2 * o)),
        (e.height =
          e.height ||
          Math.ceil(
            (function (t, e) {
        ...
        return (
          a.strokeStyle && r.strokeText(e.text, o, m),
          r.fillText(e.text, o, m),
          h
        );
      }
      function n(t) {
      ...
      var s = {
        ...
        init: function (t) {
          ...
          return (
            (i.context = i.getContext('2d')),
            (i._fontSize = {
              root: n(document.getElementsByTagName('html')[0]),
              container: n(t),
            }),
            i
          );
        ...
        clear: function (t, i) {
          ...
          for (var e = 0; e < i.length; e++) i[e].canvas = null;
        },
        resize: function (i, e, n) {
          (i.width = e * t),
            (i.height = n * t),
            (i.style.width = e + 'px'),
            (i.style.height = n + 'px');
        ...
        setup: function (t, i) {
          for (var n = 0; n < i.length; n++) {
            var s = i[n];
            s.canvas = e(s, t._fontSize);
          }
        },
        render: function (i, e) {
          i.context.drawImage(e.canvas, e.x * t, e.y * t);
        },
        remove: function (t, i) {
          i.canvas = null;
        },
      ...
      function h(t) {
        var i = this,
          e = this.media ? this.media.currentTime : Date.now() / 1e3,
          n = this.media ? this.media.playbackRate : 1;
        function s(t, s) {
          if ('top' === s.mode || 'bottom' === s.mode)
            return e - t.time < i._.duration;
          var h = ((i._.width + t.width) * (e - t.time) * n) / i._.duration;
          if (t.width > h) return !0;
          var r = i._.duration + t.time - e,
            a = i._.width + s.width,
            o = i.media ? s.time : s._utc,
            d = (a * (e - o) * n) / i._.duration,
            m = i._.width - d;
          return r > (i._.duration * m) / (i._.width + s.width);
        }
        for (
          var h = this._.space[t.mode], r = 0, a = 0, o = 1;
          o < h.length;
          o++
        ) {
          var d = h[o],
            m = t.height;
          if (
            (('top' !== t.mode && 'bottom' !== t.mode) || (m += d.height),
            d.range - d.height - h[r].range >= m)
          ) {
            a = o;
            break;
          }
        ...
        return (
          h.splice(r + 1, a - r - 1, c),
          'bottom' === t.mode
            ? this._.height - t.height - (u % this._.height)
            : u % (this._.height - t.height)
        );
      }
      var r =
        ...
        a =
          ...
          clearTimeout;
      function o(t, i, e) {
        for (var n = 0, s = 0, h = t.length; s < h - 1; )
          e >= t[(n = (s + h) >> 1)][i] ? (s = n) : (h = n);
        return t[s] && e < t[s][i] ? s : h;
      }
      function d(t) {
      ...
      function m() {
        ...
        return [
          { range: 0, time: -t, width: t, height: 0 },
          { range: t, time: t, width: 0, height: 0 },
        ];
      }
      function u(t) {
        (t.ltr = m()), (t.rtl = m()), (t.top = m()), (t.bottom = m());
      }
      function c() {
        if (!this._.visible || !this._.paused) return this;
        if (((this._.paused = !1), this.media))
          for (var t = 0; t < this._.runningList.length; t++) {
            var i = this._.runningList[t];
        ...
        var e = this,
          n = (function (t, i, e, n) {
            return function () {
              t(this._.stage);
              var s = Date.now() / 1e3,
                r = this.media ? this.media.currentTime : s,
                a = this.media ? this.media.playbackRate : 1,
                o = null,
                d = 0,
                m = 0;
              for (m = this._.runningList.length - 1; m >= 0; m--)
                (o = this._.runningList[m]),
                  r - (d = this.media ? o.time : o._utc) > this._.duration &&
                    (n(this._.stage, o), this._.runningList.splice(m, 1));
              for (
                var u = [];
                this._.position < this.comments.length &&
                ((o = this.comments[this._.position]),
                !((d = this.media ? o.time : o._utc) >= r));

              )
                r - d > this._.duration ||
                  (this.media &&
                    (o._utc = s - (this.media.currentTime - o.time)),
                  u.push(o)),
                  ++this._.position;
              for (i(this._.stage, u), m = 0; m < u.length; m++)
                ((o = u[m]).y = h.call(this, o)), this._.runningList.push(o);
              for (m = 0; m < this._.runningList.length; m++) {
                o = this._.runningList[m];
                var c =
                  ((this._.width + o.width) * (s - o._utc) * a) /
                  this._.duration;
                'ltr' === o.mode && (o.x = (c - o.width + 0.5) | 0),
                  'rtl' === o.mode && (o.x = (this._.width - c + 0.5) | 0),
                  ('top' !== o.mode && 'bottom' !== o.mode) ||
                    (o.x = (this._.width - o.width) >> 1),
                  e(this._.stage, o);
              }
            };
          })(
        ...
        return (
          (this._.requestID = r(function t() {
            n.call(e), (e._.requestID = r(t));
          })),
          this
        );
      }
      ...
      function f() {
        ...
        this.clear(), u(this._.space);
        var t = o(this.comments, 'time', this.media.currentTime);
        return (this._.position = Math.max(0, t - 1)), this;
      }
      function _(t) {
        (t.play = c.bind(this)),
          (t.pause = l.bind(this)),
          (t.seeking = f.bind(this)),
      ...
      function p(t) {
        ...
        for (var i = 0; i < this.comments.length; i++)
          this.comments[i].mode = d(this.comments[i].mode);
        return (
          (this._.runningList = []),
          (this._.position = 0),
          (this._.paused = !0),
          this.media && ((this._.listener = {}), _.call(this, this._.listener)),
          ...
          (this._.space = {}),
          u(this._.space),
          (this.media && this.media.paused) || (f.call(this), c.call(this)),
          this
        );
      }
      function v() {
        if (!this.container) return this;
        for (var t in (l.call(this),
        this.clear(),
        this.container.removeChild(this._.stage),
        this.media && g.call(this, this._.listener),
        this))
          Object.prototype.hasOwnProperty.call(this, t) && (this[t] = null);
        return this;
      }
      var w = ['mode', 'time', 'text', 'render', 'style'];
      function y(t) {
        if (!t || '[object Object]' !== Object.prototype.toString.call(t))
          return this;
        for (var i = {}, e = 0; e < w.length; e++)
          void 0 !== t[w[e]] && (i[w[e]] = t[w[e]]);
        if (
          ...
          var n = 0;
          void 0 === i.time
            ? ((i.time = this.media.currentTime), (n = this._.position))
            : (n = o(this.comments, 'time', i.time)) < this._.position &&
              (this._.position += 1),
            this.comments.splice(n, 0, i);
        } else this.comments.push(i);
        return this;
      }
      function b() {
      ...
      function x() {
        return this._.visible
          ? (l.call(this), this.clear(), (this._.visible = !1), this)
          : this;
      }
      function L() {
        return (
      ...
      return (
        ...
        Object.defineProperty(E.prototype, 'speed', k),
        E
      );
    });
    ...
    function initButton() {
      ...
      console.log('正在初始化UI');
      var parent = _$('.videoOsd-centerButtons').parent();
      ...
      var danmakuDisplay = document.createElement('button', {
        class:
          'btnGuide hide paper-icon-button-light icon-button-conditionalfocuscolor',
      ...
      _$('#displayDanmaku').click(function () {
      ...
      _$('#searchDanmaku').click(async function () {
        window.ede.is_new_video = false;
        console.log('手动匹配弹幕');
        await initDanmaku(false);
      });
      _$('#translateDanmaku').click(function () {
        console.log('切换简繁转换');
    ...
    function getDanmaku(is_auto, item) {
      ...
      _$.getJSON(searchUrl, function (data) {
        console.log('查询成功');
        console.log(data);
        var selecAnime_id = 0;
        if (anime_id != 0) {
        ...
        if (data.animes[selecAnime_id].type == 'tvseries') {
          window.ede.episode_info +=
            '\n分集名称:' +
            data.animes[selecAnime_id].episodes[episode].episodeTitle;
        }
    ...
    function list2string($obj2) {
      ...
      var anime_lists = $animes.map(($single_anime) => {
        return (
          $single_anime.animeTitle + ' 类型:' + $single_anime.typeDescription
        );
      });
    ...
    if (!window.ede) {
      ...
      setInterval(() => {
        _$('.videoOsd-centerButtons').wait(initButton);
      }, 1000);
    }
  }
})();
